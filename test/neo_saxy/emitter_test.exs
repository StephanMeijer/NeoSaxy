defmodule NeoSaxy.EmitterTest do
  use ExUnit.Case, async: true

  alias NeoSaxyTest.ControlHandler
  ...
  defp parse(data, handler, state) do
    assert result = NeoSaxy.parse_string(data, handler, state)
    assert NeoSaxy.parse_stream([data], handler, state) == result
