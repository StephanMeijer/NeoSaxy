defmodule NeoSaxy.Parser.Builder do
  @moduledoc false

  import NeoSaxy.Parser.Lookahead
  import NeoSaxy.BufferingHelper
  import NeoSaxy.Emitter
  import NeoSaxy.Guards

  alias NeoSaxy.Parser.Utils
  alias NeoSaxy.Emitter
